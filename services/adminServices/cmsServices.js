...
exports.manageCms = async (req) => {
  try {
    ...
    // Handle ADD operation (POST)
    if (req.method === 'POST') {
      cmsObj.CreatedBy = Id;
      cms = await db.Page.create(cmsObj);
      
      // Handle version history for new CMS
      ...
      res_arr.statusCode = common.response_status_code.bad_request;
      res_arr.message = common.response_msg.invalid_request_method;
    }
